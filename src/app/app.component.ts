...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  contact(){
    window.location.href="mailto:elsawy269@gmail.com";
   }
  constructor(private router: Router) {

  }
  contactItems=[{label:"elsawy269@gmail.com" },
  {label:"+9665076129933" }]
  ngOnInit() {
    this.WelcomeMessages.push({ severity: 'info', summary: 'Welcome, Demo NG4', detail: 'develop by elsawy269@gmail.com' });
    setInterval(() => {
    ...
    this.menuItems = [
      ...
      { label: 'Send Email', icon: 'fa-envelope-o', url:"mailto:elsawy269@gmail.com", command: (event) => handleSelected(event) },
